	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#fetchChecks').click(function(){
				...
				$(".loader").show();
				$('#show-results').empty();
				var myDataVar = { allChecks : $('#checkDetails').val(),myKey : $('#apiKeys').val()};
				var saveData = $.ajax({
					type: "POST",
					url: "resources/handler/getSlow.php",
					data: myDataVar,
					dataType: "text",
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<div class="form-group">
					...
					<label for="comment">Check IDs:</label>
					<textarea class="form-control" rows="5" id="checkDetails" placeholder="checkid,checkid,.."></textarea>
